...
//        if (null != observer) observer.addOnGlobalLayoutListener(this);
        ...
        mScaleDragDetector = VersionedGestureDetector.INSTANCE.newInstance(imageView.getContext(), this);
...
//        imageView.post(mCurrentFlingRunnable);
    ...
    public float setMinimumScaleToFit(Drawable drawable) {
        ...
        final float cropWindowWidth = Edge.Companion.getWidth();
        final float cropWindowHeight = Edge.Companion.getHeight();
        if (h <= w) {
...
//        return new Rect(edgeL, edgeT, edgeR, edgeB);
    ...
    public Bitmap getCroppedImage() {
        ...
        Rect displayedImageRect = ImageViewUtil.INSTANCE.getBitmapRectCenterInside(visibleBitmap, getImageView());
        ...
        float cropWindowWidth = Edge.Companion.getWidth();
        float cropWindowHeight = Edge.Companion.getHeight();
